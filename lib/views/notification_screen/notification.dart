...
class NotificationPage extends StatelessWidget {
  ...
  // Khởi tạo controller giống như AuthController trong SignupScreen

  @override
  Widget build(BuildContext context) {
  final controller = Get.find<NotificationController>();

    print('🖥️ Building NotificationPage'); // Debug
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: Obx(() {
              // Debug
              print('🔄 Obx rebuild, count: ${controller.notifications.length}');
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isSelected ? redColor : lightGrey,
                  ),
                ),
